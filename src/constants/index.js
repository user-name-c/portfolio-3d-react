...
import {
  ...
  const testimonials = [
    {
  testimonial:
    "Ivan was always willing to help the team and explain technical issues clearly. He has great patience and a strong ability to understand problems and find practical solutions.",
  name: "Daniel Ruiz",
  designation: "Technical Support Specialist",
  company: "Concentrix – Wix",
  image: "https://randomuser.me/api/portraits/men/32.jpg",
},
{
  testimonial:
    "Working with Ivan was great. He stays calm under pressure, understands systems quickly, and is always open to learning new tools or improving processes.",
  name: "Andrea López",
...
{
  testimonial:
    "Ivan has strong analytical thinking and attention to detail. He was reliable when handling complex cases and consistently showed a problem-solving mindset.",
  name: "Luis Hernández",
